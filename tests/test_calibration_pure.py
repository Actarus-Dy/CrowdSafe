...
Agent #23 Scientific Validation Tester -- CrowdSafe (C-01)
"""
...
from crowdsafe.core.calibration_pure import (
    RHO_JAM,
    V_FREE_MS,
    run_generation_test,
...
class TestDimensionalAnalysis:
    ...
    def test_force_softening_scale(self) -> None:
        """Softening length should be comparable to inter-pedestrian spacing.

        At 30 veh/km, mean spacing = 1000/30 = 33.3 m.
        Softening of 10 m is about 1/3 of this spacing -- physically reasonable.
        """
        # At 30 veh/km on 2km road: 60 pedestrians, spacing ~33m
        # At 120 veh/km: 240 pedestrians, spacing ~8.3m
...
class TestGenerationVsPreservation:
    ...
    def test_generation_print_results(self) -> None:
        ...
        print("All pedestrians start at v_free regardless of density.")
        print("Question: does gravity slow pedestrians at high density?")
        print("=" * 80)
        print(f"R^2: {result['r_squared']:.6f}")
