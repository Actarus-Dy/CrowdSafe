"""Tests for PedestrianAgent -- Mesa ABM agent for CrowdSafe.
...
@pytest.fixture
def default_agent(stub_model: StubModel) -> PedestrianAgent:
...
class TestCreation:
    ...
    def test_position_dtype(self, default_agent: PedestrianAgent) -> None:
        assert default_agent.position.dtype == np.float64

    def test_velocity_dtype(self, default_agent: PedestrianAgent) -> None:
        assert default_agent.velocity.dtype == np.float64

    def test_position_values(self, default_agent: PedestrianAgent) -> None:
        np.testing.assert_array_equal(default_agent.position, [0.0, 0.0])

    def test_velocity_values(self, default_agent: PedestrianAgent) -> None:
        np.testing.assert_array_equal(default_agent.velocity, [25.0, 0.0])

    def test_default_local_density(self, default_agent: PedestrianAgent) -> None:
        assert default_agent.local_density == 30.0

    def test_default_v_max(self, default_agent: PedestrianAgent) -> None:
        assert default_agent.v_max == 36.0

    def test_default_mass(self, default_agent: PedestrianAgent) -> None:
        assert default_agent.mass == 0.0

    def test_default_mass_type(self, default_agent: PedestrianAgent) -> None:
        assert default_agent.mass_type == "neutral"

    def test_unique_id_is_assigned(self, default_agent: PedestrianAgent) -> None:
...
class TestSpeed:
    ...
    def test_axis_aligned(self, default_agent: PedestrianAgent) -> None:
    ...
    def test_returns_float(self, default_agent: PedestrianAgent) -> None:
...
class TestSpeedKmh:
    ...
    def test_conversion(self, default_agent: PedestrianAgent) -> None:
...
class TestUpdateFromSimulation:
    def test_position_updated(self, default_agent: PedestrianAgent) -> None:
    ...
    def test_velocity_updated(self, default_agent: PedestrianAgent) -> None:
        default_agent.update_from_simulation(
            position=np.array([0.0, 0.0]),
    ...
    def test_mass_updated(self, default_agent: PedestrianAgent) -> None:
        default_agent.update_from_simulation(
            position=np.array([0.0, 0.0]),
    ...
    def test_dtype_enforced(self, default_agent: PedestrianAgent) -> None:
    ...
    def test_accepts_lists(self, default_agent: PedestrianAgent) -> None:
...
class TestToDict:
    def test_expected_keys(self, default_agent: PedestrianAgent) -> None:
    ...
    def test_types_are_json_serialisable(self, default_agent: PedestrianAgent) -> None:
...
class TestStep:
    def test_step_runs_without_error(self, default_agent: PedestrianAgent) -> None:
        """step() should be a no-op and not raise."""
        default_agent.step()

    def test_step_does_not_change_state(self, default_agent: PedestrianAgent) -> None:
...
class TestRepr:
    def test_repr_contains_id(self, default_agent: PedestrianAgent) -> None:
        r = repr(default_agent)
        assert "PedestrianAgent" in r
