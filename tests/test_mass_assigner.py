"""Tests for crowdsafe.core.mass_assigner.MassAssigner.

Covers:
    1. Pedestrian slower than v_mean  ->  positive mass
    2. Pedestrian faster than v_mean  ->  negative mass
    3. Pedestrian at v_mean           ->  mass ~ 0 (neutral)
    4. beta parameter affects magnitude correctly
    5. rho_scale normalisation works
    6. Vectorization stress test (1 M pedestrians)
...
# =====================================================================
# 1. Slow pedestrian -> positive mass
# =====================================================================


class TestSlowPedestrian:
    """A pedestrian slower than v_mean must receive positive mass."""

    def test_single_slow_pedestrian(self, default_assigner: MassAssigner) -> None:
    ...
    def test_multiple_slow_pedestrians(self, default_assigner: MassAssigner) -> None:
...
# =====================================================================
# 2. Fast pedestrian -> negative mass
# =====================================================================


class TestFastPedestrian:
    """A pedestrian faster than v_mean must receive negative mass."""

    def test_single_fast_pedestrian(self, default_assigner: MassAssigner) -> None:
    ...
    def test_multiple_fast_pedestrians(self, default_assigner: MassAssigner) -> None:
...
# =====================================================================
# 3. Pedestrian at v_mean -> neutral (mass ~ 0)
# =====================================================================


class TestNeutralPedestrian:
    """A pedestrian exactly at v_mean should have mass = 0."""
...
class TestVectorization:
    ...
    def test_one_million_pedestrians(self, default_assigner: MassAssigner) -> None:
...
class TestEndToEnd:
    ...
    def test_mixed_population(self, default_assigner: MassAssigner) -> None:
        # Slow, fast, and at-mean pedestrians
    ...
    def test_analytical_values(self) -> None:
        ...
        # Pedestrian 0: delta=5, |5|^2=25, sign=+1, rho/rho0=2.0 -> +50.0
        assert masses[0] == pytest.approx(50.0, rel=1e-12)
        # Pedestrian 1: delta=-5, |5|^2=25, sign=-1, rho/rho0=4.0 -> -100.0
