...
All notable changes to CrowdSafe (C-01) will be documented in this file.
...
- Predict: clone under lock, run_until outside lock, max_steps guard, 0-pedestrian early return
