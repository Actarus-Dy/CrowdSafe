...
Usage:
    python -m crowdsafe.validation.report
...
from crowdsafe.validation.emergence import run_emergence_analysis
from crowdsafe.validation.fundamental_diagram import run_fd_sweep
...
def main():
    ...
    print("Running CrowdSafe validation suite (full)...")
    report = run_validation_suite(quick=False)

    print(f"\n{'=' * 60}")
    print("CrowdSafe Validation Report")
    print(f"{'=' * 60}")
